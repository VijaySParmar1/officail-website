...
<body>
    <div class="container-xxl bg-white p-0">
            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="contact_request.php" class="nav-item nav-link active">Contact us</a>
                ...
                <div class="container text-center">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            ...
                            <li class="breadcrumb-item text-white active" aria-current="page">Contact Request</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="container">
          ...
          <form method='post' action='function/download.php'><br>
            ...
            <script>
                  ...
                  // Download selected button
                    $("#download_selected").click(function () {
                        ...
                        var url = "function/download.php?ids=" + selected.join(',');
                        window.location.href = url;
                    });

                
                  // Select and unselect button
                        ...
                        $("#delete_selected").click(function () {
                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    window.location.href = "contact_request.php";
                                },
