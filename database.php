...
<body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        <a href="database.php" class="nav-item nav-link active">Home</a>
                        <a href="quote_request.php" class="nav-item nav-link">Quote</a>
                        <a href="contact_request.php" class="nav-item nav-link">Contact us</a>
                        <a href="application_request.php" class="nav-item nav-link">Job Applications</a>
    ...
    // Total entries for Quote Request
    $quoteTotal = mysqli_num_rows(mysqli_query($connection, "SELECT * FROM quote"));
    
    // Total entries for Contact Request
    $contactTotal = mysqli_num_rows(mysqli_query($connection, "SELECT * FROM contact"));

    // Total entries for Application Request
    $applicationTotal = mysqli_num_rows(mysqli_query($connection, "SELECT * FROM job"));

    // Links to respective request pages
    $quoteRequest = "quote_request.php";
    $contactRequest = "contact_request.php";
    $applicationRequest = "application_request.php";
?>

<div class="container my-4">
    <h2 class="text-center mb-4">Total Requests</h2>
    <div class="row justify-content-center">
        <div class="col-md-8">
            <table class="table table-striped table-hover table-bordered">
                ...
                <tbody>
                    <tr>
                        <td><a href="<?php echo $quoteRequest; ?>" class="link-primary">Quote Request</a></td>
                        <td><?php echo $quoteTotal; ?></td>
                    </tr>
                    <tr>
                        <td><a href="<?php echo $contactRequest; ?>" class="link-primary">Contact Request</a></td>
                        <td><?php echo $contactTotal; ?></td>
                    </tr>
                    <tr>
                        <td><a href="<?php echo $applicationRequest; ?>" class="link-primary">Application Request</a></td>
                        <td><?php echo $applicationTotal; ?></td>
                    </tr>
                </tbody>
            </table>
        </div>
